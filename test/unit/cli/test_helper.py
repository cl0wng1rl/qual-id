...
class TestHelper(unittest.TestCase):
    ...
    def test__is_help__long_help_flag__true(self):
        """Helper -> is_help - long help flag"""
        helper = MockHelper(["arg1", self.HELP_LONG, "arg2"])
        self.assertTrue(helper.is_help())

    def test__is_help__short_help_flag__true(self):
        """Helper -> is_help - short help flag"""
        helper = MockHelper(["arg1", self.HELP_SHORT, "arg2"])
        self.assertTrue(helper.is_help())

    def test__is_help__no_help_flag__false(self):
        """Helper -> is_help - no help flag"""
