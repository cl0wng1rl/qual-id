...
class TestCategoryHelper(unittest.TestCase):
  ...
  def test__get_values_is_valid__with_invalid_category_due_to_spaces__returns_false(self):
  ...
  def test__get_values_is_valid__with_invalid_category_due_to_dashes__returns_false(self):
