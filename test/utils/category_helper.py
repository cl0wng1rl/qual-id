class CategoryHelper:
    ...
    def get_values_is_valid(category):
        ...
        does_not_contain_invalid_string = (
            CategoryHelper.get_values_does_not_contain_invalid_string(category)
        )
        does_not_contain_repeats = CategoryHelper.get_values_does_not_contain_repeats(
            category
        )
        return (
            returns_a_list
            and does_not_contain_invalid_string
            and does_not_contain_repeats
        )
    ...
    def get_values_does_not_contain_invalid_string(category):
        return not any(
            [
                CategoryHelper.string_contains_disallowed_character(value)
